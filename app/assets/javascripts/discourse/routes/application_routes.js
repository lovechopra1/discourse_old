...
Discourse.Route.buildRoutes(function() {
  var router = this;
	...
	this.resource('mcgpsychometricindex', { path: '/psychometric-career-assessment' });
	this.resource('mcgaftertenth', { path: '/what-to-do-after-10th' });
	this.resource('mcgengineeringassessment', { path: '/how-to-choose-right-engineering-branch' });
